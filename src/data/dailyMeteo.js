export const dailyMeteo = (data) => {
    ...
    const daily = data.reduce((acc, curr) => {
        ...
        dayData.maxTemp = curr.main.temp > dayData.maxTemp ? curr.main.temp : dayData.maxTemp;
        dayData.minTemp = curr.main.temp < dayData.minTemp ? curr.main.temp : dayData.minTemp;
        dayData.windSpeed = curr.wind.speed > dayData.windSpeed ? curr.wind.speed : dayData.windSpeed;
